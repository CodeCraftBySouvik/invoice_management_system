    ...
    <div class="container">
        <div class="row align-items-center min-vh-100">
            <div class="col-md-6 mx-auto text-center">
                ...
                <a href="{{ route('home') }}" type="button" class="btn btn-primary-app me-md-1">Signup Now</a>
                <a href="{{ route('home') }}" type="button" class="btn btn-primary-app ms-md-1">Play Demo</a>
            </div>
        </div>
    </div>
</section>
...
<section class="about py-5" id="about">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-6">
                <img class="img-fluid mb-2 mb-md-0" src="{{ asset('frontend/img/img-placeholder.svg') }}" alt="Image" width="770" height="480" loading="lazy" />
            </div>
            <div class="col-md-6">
...
<section class="pricing py-5" id="pricing">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="card bg-secondary-app rounded-0 border-0 px-5 py-2 mb-2">
                    <div class="card-body text-center">
                        ...
                        <a href="{{ route('home') }}" type="button" class="btn btn-primary-app ms-md-1">Start Now</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
...
<section class="newsletter py-2" id="newsletter">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <img class="img-fluid" src="{{ asset('frontend/img/img-placeholder-newsletter.svg') }}" alt="Image" width="1568" height="248" loading="lazy" />
            </div>
        </div>
    </div>
</section>
