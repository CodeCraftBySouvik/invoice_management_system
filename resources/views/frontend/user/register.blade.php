                        ...
                        <div class="card-body p-0">
                            <ul class="toggle-pills nav nav-pills mb-4 mx-auto" id="login-tab" role="tablist">
                                <li class="nav-item flex-grow-1" role="presentation">
                                    <button class="nav-link text-dark w-100 {{ session('active_tab', 'pills-1') == 'pills-1' ? 'active' : '' }}" id="pills-tab-1" data-bs-toggle="pill" data-bs-target="#pills-1" type="button" role="tab" aria-controls="pills-1" aria-selected="true">Use Email ID</button>
                                </li>
                                <li class="nav-item flex-grow-1" role="presentation">
                                    <button class="nav-link text-dark w-100 {{ session('active_tab', 'pills-1') == 'pills-2' ? 'active' : '' }}" id="pills-tab-2" data-bs-toggle="pill" data-bs-target="#pills-2" type="button" role="tab" aria-controls="pills-2" aria-selected="false">Use Phone</button>
                                </li>
                            </ul>
                            <div class="tab-content pt-3" id="pills-tabContent">
                                <div class="tab-pane fade {{ session('active_tab', 'pills-1') == 'pills-1' ? 'show active' : '' }}" id="pills-1" role="tabpanel" aria-labelledby="pills-tab-1" tabindex="0">
                                ...
                                <div class="tab-pane fade {{ session('active_tab', 'pills-1') == 'pills-2' ? 'show active' : '' }}" id="pills-2" role="tabpanel" aria-labelledby="pills-tab-2" tabindex="0">
                                    <form method="POST" action="{{ route('register.submit') }}" enctype="multipart/form-data" class="needs-validation" novalidate="">
                                    @csrf
