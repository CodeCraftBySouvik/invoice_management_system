...
<section class="register py-2 py-md-5" id="register">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <img class="img-fluid mb-5 mb-md-0" src="{{ env('COMMON_HOST') . 'assets/frontend/img/checkout-success.svg' }}" alt="Image" width="677" height="738" loading="lazy" />
            </div>
            <div class="col-md-6">
                                ...
                                <div class="tab-pane fade show active" id="pills-1" role="tabpanel" aria-labelledby="pills-tab-1" tabindex="0">
                                    ...
                                    <input type="hidden" name="form-name" value="withEmail">
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <p class="text-center mb-2"><a href="{{ route('home') }}" class="text-body-emphasis text-decoration-underline">Forgot Password</a></p>
