            ...
            <div class="box py-2 py-md-4">
                ...
                <div class="row py-2 py-md-4">
                    ...
                    <div class="col-md-4">
    				    <div class="form-group">
    				        <label>Date</label>
						    <input type="text" class="form-control" placeholder="" name="date" value="06/10/2024" disabled>
                        </div>
    				</div>
                    <div class="col-md-4">
    				    <div class="form-group">
    				        <label>Valid Till</label>
						    <input type="text" class="form-control" placeholder="" name="valid_till" value="12/10/2024" disabled>
                        </div>
    				</div>
                    <div class="col-md-4">
    				    <div class="form-group">
    				        <label>TRN - VAT Number</label>
						    <input type="text" class="form-control" placeholder="" name="trn_vat_number" value="1234561234561234" disabled>
					    </div>
    				</div>
                    <div class="col-md-8">
                        <div class="form-group">
                            <label>Company For</label>
                            <select class="form-select form-control" name="customer" id="customer" disabled>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select class="form-select form-control" name="payment_status" id="payment_status" disabled>
                                <option value="" selected disabled></option>
                    ...
                    <table id="{{ $page['term'] }}_list" class="table table-v2">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <div class="form-group">
                                        <select class="form-select form-control" name="product[]" id="product" disabled>
                                            <option value="" selected disabled></option>
                                            <option value="1" selected>Hand Sanitizer</option>
                                            <option value="2"  >Select 3</option>
                                            <option value="3"  >Select 4</option>
                                        </select>
                                    </div>
                                ...
                                <td>
                                    <div class="form-group">
                                        <input type="text" class="form-control text-end" placeholder="" name="quantity[]" value="100" disabled>
                                    </div>
                                </td>
                                <td>
                                    <div class="form-group">
                                        <input type="text" class="form-control text-end" placeholder="" name="rate[]" value="110.75" disabled>
                                    </div>
                                </td>
                                <td></td>
                                <td>
                            ...
                            <!-- <tr>
                                <td>
                                    <button class="btn btn-primary-app btn-add">Add Item</button>
                                </td>
                            </tr> -->
                        </tbody>
                    </table>
                ...
                <div class="row py-2 py-md-4 border-bottom border-top border-dark-subtle">
                    <div class="col-md-6">
                        <div class="form-group m-0">
    				        <label>Note</label>
						    <textarea class="form-control" placeholder="" name="note" rows="2" disabled>{{ old('note') }}</textarea>
					    </div>
                    </div>
                    <div class="col-md-2">
                    </div>
                    <div class="col-md-4">
                        ...
                        <div class="row py-1 align-items-center border-bottom border-dark-subtle">
                            ...
                            <div class="col-md-4">
                                <div class="form-group m-0">
                                    <input type="text" class="form-control discount text-end" placeholder="" name="discount[]" value="0.00" disabled>
                                </div>
                            </div>
                        </div>
