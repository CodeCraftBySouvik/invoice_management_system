            ...
            <div class="box py-2 py-md-4">
                ...
                <div class="page-heading d-flex flex-column flex-md-row align-items-start align-items-md-center justify-content-between pb-2 pb-md-4 border-bottom border-light-subtle">
                    ...
                    <div class="buttons d-flex flex-wrap align-items-center justify-content-md-end">
                        <a href="{{ route('admin.'. $page['term'] .'.print', ['id' => 5]) }}" type="button" class="btn btn-primary-app">Print</a>
                ...
                <div class="row py-2 py-md-4">
                    <div class="col-md-4">
    				    <div class="form-group">
						    ...
						    <input type="text" class="form-control" placeholder="" name="invoice_number" value="#55" disabled>
					    </div>
    				</div>
                    <div class="col-md-4">
    				    <div class="form-group">
                    ...
                    <div class="col-md-4">
    				    <div class="form-group">
						    ...
						    <input type="text" class="form-control" placeholder="" name="valid_till" value="{{ old('valid_till') }}" required>
                        </div>
    				</div>
                    <div class="col-md-4">
    				    <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <select class="form-select form-control" name="customer" id="customer">
                                ...
                                <option value="1"  >Advanced Network Solutions</option>
                ...
                <div class="row py-2 py-md-4 border-bottom border-top border-dark-subtle">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="row py-1 align-items-center border-bottom border-dark-subtle">
                            ...
                            <div class="col-md-4">
                                <div class="form-group m-0">
                                    <input type="text" class="form-control discount text-end" placeholder="" name="discount[]" value="0.00">
                                </div>
                            </div>
                        </div>
