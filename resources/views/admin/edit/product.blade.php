                ...
                <div class="row py-2 py-md-4">
                    ...
                    <div class="col-md-4">
    				    <div class="form-group">
						    ...
						    <input type="text" class="form-control" placeholder="" name="product_name" value="Shampoo Terra" required>
                    ...
                    <div class="col-md-4">
    				    <div class="form-group">
						    ...
						    <input type="text" class="form-control text-end" placeholder="" name="buy_price" value="75.00">
					    </div>
    				</div>
                    <div class="col-md-4">
    				    <div class="form-group">
    				        <label>Sell Price</label>
						    <input type="text" class="form-control text-end" placeholder="" name="sell_price" value="110.00">
					    </div>
    				</div>
                    <div class="col-md-4">
    				    <div class="form-group">
    				        <label>Quantity in stock</label>
						    <input type="text" class="form-control" placeholder="" name="quantity" value="550">
					    </div>
    				</div>
                    <div class="col-md-8">
    				</div>
