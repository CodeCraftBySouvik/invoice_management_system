                ...
                <div class="row py-2 py-md-4">
                    ...
                    <div class="col-md-8">
    				    <div class="form-group">
						    ...
						    <input type="text" class="form-control" placeholder="" name="company_name" value="Advanced Network Solutions">
                        </div>
    				</div>
                    <div class="col-md-4">
    				    <div class="form-group">
    				        <label>TRN - VAT Number</label>
						    <input type="text" class="form-control" placeholder="" name="trn_vat_number" value="123456789123456">
					    </div>
    				</div>
                    <div class="col-md-4">
    				    <div class="form-group">
    				        <label>Email ID</label>
						    <input type="text" class="form-control" placeholder="" name="email" value="admin@ans.com">
					    </div>
    				</div>
                    <div class="col-md-4">
    				    <div class="form-group">
    				        <label>Phone Number</label>
						    <input type="text" class="form-control" placeholder="" name="phone" value="+971 04123456">
					    </div>
    				</div>
                    {{--<div class="col-md-4">
                        <div class="form-group">
                    ...
                    <div class="col-md-4">
    				    <div class="form-group">
    				        <label>Address</label>
						    <input type="text" class="form-control" placeholder="" name="address" value="#011, Al Salman Tower, Shaikh Zayed Road">
					    </div>
    				</div>
                    <div class="col-md-4">
    				    <div class="form-group">
    				        <label>City</label>
						    <input type="text" class="form-control" placeholder="" name="city" value="Dubai">
					    </div>
    				</div>
                    <div class="col-md-4">
                        <div class="form-group">
                    ...
                    <div class="col-md-8">
    				    <div class="form-group">
    				        <label>Comment</label>
						    <textarea class="form-control" placeholder="" name="comment" rows="5">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed nec erat a metus interdum porta. Vivamus quis diam non orci vehicula cursus a id metus.</textarea>
					    </div>
    				</div>
                </div>
            </div>
